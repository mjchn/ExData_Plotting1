...
with(powerdata, plot(Global_active_power~DateTime,type="l", ylab="Global Active Power (kilowatts)", xlab=""))

#Save the plot as PNG
if(!file.exists("./Module 4 Project 1/Plots")) 
{dir.create("./Module 4 Project 1/Plots")}

dev.copy(png, file="./Module 4 Project 1/Plots/Plot2.png", height=480, width=480)
dev.off()
